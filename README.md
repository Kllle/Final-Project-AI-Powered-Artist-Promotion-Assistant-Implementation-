...
Students: Kaylee Auguillard, Bradley Johnson, Florentin Degbo, Stanley Huynh
...
- Lead management approval and denial workflow
...
This working Proof of Concept (POC) showcases:
...
- Live Monitoring Simulation
     - Simulates tracking across multiple digital platforms such as Instagram, TikTok, YouTube, and LinkedIn.
...
- Approval and Denial Workflow so users can:
...
Final scores range from 0 to 100 and are used to rank and prioritize promotional opportunities.

This logic is fully simulated for the purposes of the Proof of Concept.
...
- Live monitoring across two or more platforms
- AI analysis and opportunity scoring
- Lead approval and denial workflow
- Performance analytics dashboard
- Mock data pools
...
- All metrics and analytics are mock-generated

# 📈 Future Enhancements
- Live social media API monitoring
- True AI and machine learning opportunity ranking
- Automated artist outreach emails
- Campaign ROI prediction
- CRM system integration
- Spotify, Instagram, TikTok, and YouTube API support
